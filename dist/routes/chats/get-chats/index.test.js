...
describe('Route Access', function () {
    it('has a route handler listening to /api/chats for post requests', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app).get('/api/chats').send({})];
                case 1:
                    response = _a.sent();
    ...
    it('can only be accessed if a user is signed in', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app).get('/api/chats').send({}).expect(401)];
                case 1:
                    response = _a.sent();

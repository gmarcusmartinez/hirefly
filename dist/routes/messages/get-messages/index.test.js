...
describe('Route Access', function () {
    it('has a route handler listening to /api/messages/:chatId for get requests', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app).get('/api/messages/:chatId')];
                case 1:
                    response = _a.sent();
...
describe('Unsuccessful Message Fetch: User does not belong to chat', function () {
    var user;
    var partner;
    var partnerId;
    var chatResponse;
    ...
    it('returns a 401 error', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app)
...
describe('Unsuccessful Message Fetch: User does not belong to chat', function () {
    ...
    it('returns a 200 response', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app)

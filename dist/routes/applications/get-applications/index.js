...
exports.getApplications = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var job, applications;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Job_1.Job.findById(req.params.jobId)];
            case 1:
                job = _a.sent();
                if (!job)
                ...
                return [4 /*yield*/, Application_1.Application.find({
                        jobId: job._id,
                        status: 'pending',
                    }).populate({

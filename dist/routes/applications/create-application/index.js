...
exports.createApplication = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var applicant, jobId, job, msg, existingApplication, duplicate, profile, application;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                msg = 'You can not apply for a job which you have created.';
                if (job.creator.toString() === applicant)
            ...
            case 2:
                ...
                duplicate = 'You have already sent an application for this job.';
                if (existingApplication)
                    throw new common_1.BadRequestError(duplicate);
                return [4 /*yield*/, Profile_1.Profile.findOne({ userId: req.currentUser._id })];
            case 3:
                profile = _a.sent();
                if (!profile)
                    throw new common_1.BadRequestError('You must have a profile to apply for a job.');

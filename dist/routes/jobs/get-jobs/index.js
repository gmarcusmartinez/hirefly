...
exports.getJobs = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUser, applications, applicationJobIds, user, jobs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                currentUser = req.currentUser._id;
                return [4 /*yield*/, Application_1.Application.find({ applicant: currentUser })];
            case 1:
                applications = _a.sent();
                applicationJobIds = applications.map(function (_a) {
                    var jobId = _a.jobId;
                    return jobId;
                });
                return [4 /*yield*/, User_1.User.findById(currentUser)];
            case 2:
                user = _a.sent();
                return [4 /*yield*/, Job_1.Job.aggregate([

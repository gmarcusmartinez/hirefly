...
exports.advancedResults = function (model) { return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var query, reqQuery, removeFields, queryStr, operators, results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                operators = /\b(gt|gte|lt|lte|in|regex)\b/g;
                queryStr = queryStr.replace(operators, function (match) { return "$" + match; });

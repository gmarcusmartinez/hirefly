...
var chats_1 = require("./routes/chats");
...
var applications_1 = require("./routes/applications");
...
app.use('/api/applications', applications_1.applicationsRouter);
app.use('/api/auth', auth_1.authRouter);
app.use('/api/chats', chats_1.chatsRouter);
